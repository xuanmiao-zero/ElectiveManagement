...
%>
    <h3>将学生信息修改为:</h3>
<form action="updatestudentShow.jsp"method="post"onSubmit="return validate()">
...
<h4>邮件：<input type="text" name="email" value=" <%=rs.getString("email")%>" title="邮件可以为空不能为空"> </input><br></h4>
